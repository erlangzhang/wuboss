        ...
        <div class='table-container'>
            ...
            <el-table :data="datas" v-loading="loading" element-loading-text="加载中" border style="width: 100%" @sort-change='handleSortChange' @filter-change="getChargeType">
                ...
                <el-table-column label="操作" v-if="columnsChecked.opt" show-overflow-tooltip>
                    <template scope="scope">
                        <router-link class="retrieve-btn" :to="'/content/rejected-detail?id='+scope.row.id">
...
export default {
    data() {
            return {
                ...
                titleList: ["内容管理", "本地生活圈", "商户审核", "驳回商户"],
                statusList: [{
                    text: '待审核',
                    value: '0'
                }, {
        ...
        methods: {
            ...
            fetch() {
                ...
                this.loading = true;
                contentStore.listRejectedMerchantInfo(params).then(res => {
